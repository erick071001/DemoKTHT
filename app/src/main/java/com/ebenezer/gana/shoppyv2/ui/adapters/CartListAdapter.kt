...
class CartListAdapter(
    ...
    inner class ViewHolder(val binding: ListItemCartBinding) : View.OnClickListener,
        ...
        fun bind(cart: Cart) {
            ...
            binding.tvCartItemPrice.text = "${cart.product.price.toDouble()*cart.item.quantity}$"
            binding.tvCartQuantity.text = cart.item.quantity.toString()
...
//            binding.ibRemoveCartItem.setOnClickListener(this)
            ...
            if (cart.item.quantity.toString() == "0") {
...
//                        if (cart.item.quantity.toString() == "1") {
//                            FirestoreClass()
...
//                        val cartQuantity: Int = cart.item.quantity.toInt()
//
